                    ...
                    <Col lg={12}>
                        ...
                        <div className="form-group">
                            ...
                            <Autocomplete
                                ...
                                options={this.props.progcanceldetails}
                                onChange={(event, value) => {
                                    console.log('value ' + value)
                                  
                                    {this.props.GetprogcancelDetails(value)}
                                    
                                }}
                                // onChange={this.props.handleChange}
                                value={this.props.progcanceldata.selectedchangedactivitydetails}
                        ...
                        <div className="form-group">
                            ...
                            <Input
                                type="textarea"
                                id="comments"
                                value={this.props.progcanceldata.comments}
                                // onChange={this.props.GetcommentDetails()}
                                onChange={(event, value) => {
                                    console.log('value ' + value)
                                  
                                    {this.props.GetprogcancelcommentDetails(event)}
...
export default withRouter(ActivityCancellation);